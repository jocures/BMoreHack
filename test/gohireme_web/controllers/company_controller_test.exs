defmodule GohiremeWeb.CompanyControllerTest do
  use GohiremeWeb.ConnCase

  alias Gohireme.Accounts

  @create_attrs %{company_description: "some company_description", company_logo: "some company_logo", company_name: "some company_name", company_url: "some company_url"}
